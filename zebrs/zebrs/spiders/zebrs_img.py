...
class ZebrsImgSpider(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(restrict_xpaths=('//div[@class = "position-relative teaser"]')), callback="parse_item", follow=True),
    ...
    def parse_item(self, response):
        ...
        relative_image_urls = response.xpath('//ul[@id="product-zoom"]/li/div/img/@src').getall()
